export const MOCK_GENERATED_SPRITE = `
...
export function createMockGeneratedItem(itemId, itemNumber) {
  return {
...
export function buildMockGenerateItemResponse({ itemId, itemNumber }) {
  return {
    item: createMockGeneratedItem(itemId, itemNumber),
    meta: {
      source: "mock-backend",
